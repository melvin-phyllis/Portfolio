...
const AboutSection = () => {
    return (
        <>
            <div className="flex  flex-col md:flex-row md:m-20 md:h-180 gap-20  font-mono px-4 md:px-20">
                ...
                <div className="md:text-xl md:w-1/2 flex flex-col justify-center gap-5">
                    <h2 className="text-center text-4xl  font-bold ">A propos de Moi</h2>
